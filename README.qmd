...
## Humans plan for the near future to walk economically on uneven terrain [@darici2022HumansPlanFuture]
![walking on uneven terrain](img/uneventerrainwalking.svg)
This [notebook](src/shortwalks.ipynb) demonstrates a dynamic optimization for walking on uneven terrain. The model plans ahead for upcoming steps, and determines a trajectory of push-offs and forward walking speed that minimizes the energy and time expended for the terrain. Energy is the push-off work performed by the model, and time is the total duration of the walk, scaled by a time valuation constant $c_t$.  
