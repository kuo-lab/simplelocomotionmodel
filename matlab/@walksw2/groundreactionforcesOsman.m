function [grf,grt,cop] = groundreactionforcesOsman(walk, x, t)

%just added u1dotAll to see the acc
...
figure; plot(u1dotAll,'b'); hold on; plot(x(:,1),'r');%position and acc are same
