function [c,ceq] = gaitConstraintsForUnevenTerrainRW2_MStoMSvariableStepLen(params, w,  desiredTime, nominalLegSpeedRW, latePushOffFlag, x_init, nominalStepSpeedRW)
...
[xe, te, xs, ts, ~, indices, ~] = onestep3_MStoMSvariableAlpha(w, x_init, [], params, latePushOffFlag, nominalStepSpeedRW);  %Original 
