...
function [xe,te,x,t,energies,indices,vinterms] = onestep5_v3(w, varargin)

%this to find numerical derivatives same as v2 but only it doesnot output
%time as a state
